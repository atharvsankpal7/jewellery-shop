...
import { Diamond, Award, Heart, Star, ChevronLeft, ChevronRight, Gift, Clock, Sparkles, Shield, Gem, Truck } from 'lucide-react';
  ...
  const newLaunches = [
    {
      ...
      description: "Inspired by the cosmos, featuring star and moon motifs in precious metals",
      price: "From $1,200"
    },
    {
    ...
    },
    {
      ...
      description: "Clean, contemporary designs in pure platinum for the modern minimalist",
      price: "From $2,800"
    },
    {
      name: "Rosegold Blush",
      image: "https://images.unsplash.com/photo-1576022162026-9b1e63666312?auto=format&fit=crop&w=800&q=80",
  ...
  const festiveSpecials = [
    {
      ...
      image: "https://images.unsplash.com/photo-1513267048331-5611cad62e41?auto=format&fit=crop&w=800&q=80",
      description: "Dazzling pieces perfect for holiday celebrations and special occasions"
    },
    {
      ...
      description: "Celebrate milestones with our curated anniversary jewelry selection"
    },
    {
      name: "Wedding Season",
      image: "https://images.unsplash.com/photo-1546167889-f5476a0e2b3b?auto=format&fit=crop&w=800&q=80",
  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Be the first to discover our latest creations, fresh from our master artisans' workshop
            </p>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              What sets Lumière apart in the world of fine jewelry
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold mb-3">Ethically Sourced Gemstones</h3>
                <p className="text-gray-600">
                  We partner exclusively with ethical mines and suppliers who adhere to the highest standards of environmental and social responsibility. Every gemstone in our collection can be traced back to its origin.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold mb-3">Custom Design Service</h3>
                <p className="text-gray-600">
                  Our master designers work one-on-one with clients to create bespoke pieces that perfectly capture personal stories and milestones. From concept to creation, we bring your vision to life.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold mb-3">Artisanal Craftsmanship</h3>
                <p className="text-gray-600">
                  Our jewelry is handcrafted using techniques passed down through generations. Each piece undergoes over 40 hours of meticulous work by our skilled artisans before it reaches you.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold mb-3">Innovative Designs</h3>
                <p className="text-gray-600">
                  We blend traditional craftsmanship with contemporary aesthetics to create pieces that are both timeless and modern. Our design team draws inspiration from art, architecture, and nature.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Celebrate life's special moments with our curated festive collections
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {festiveSpecials.map((item, index) => (
              <div key={index} className="group relative overflow-hidden rounded-xl shadow-lg h-[400px]">
                <img
                  src={item.image}
                  alt={item.name}
      ...
      <section className="py-24 bg-gradient-to-br from-green-900 to-emerald-900 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-serif font-bold mb-4">Our Quality Promise</h2>
            <p className="text-gray-300 max-w-2xl mx-auto">
              Every Lumière piece is crafted with uncompromising attention to quality and detail
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl text-center">
              ...
              <h3 className="text-xl font-serif font-bold mb-3">Lifetime Warranty</h3>
              <p className="text-gray-300">
                Every piece comes with our comprehensive lifetime warranty against manufacturing defects
              </p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl text-center">
              <Diamond className="h-12 w-12 text-emerald-300 mx-auto mb-6" />
              <h3 className="text-xl font-serif font-bold mb-3">Certified Gemstones</h3>
              <p className="text-gray-300">
                All our gemstones are certified by internationally recognized gemological laboratories
              </p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl text-center">
              <Truck className="h-12 w-12 text-emerald-300 mx-auto mb-6" />
              <h3 className="text-xl font-serif font-bold mb-3">Secure Delivery</h3>
              <p className="text-gray-300">
                Fully insured worldwide shipping with discreet packaging for your privacy
              </p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl text-center">
              <Heart className="h-12 w-12 text-emerald-300 mx-auto mb-6" />
              <h3 className="text-xl font-serif font-bold mb-3">Satisfaction Guarantee</h3>
              <p className="text-gray-300">
                30-day return policy if you're not completely satisfied with your purchase
              </p>
            </div>
          </div>
